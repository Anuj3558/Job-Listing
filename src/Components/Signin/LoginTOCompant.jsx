...
const CompanyLogin = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Here you would typically check the company code or make an API request
    console.log('Company Code:', companyCode);
    
    // If the company code is valid, navigate to the company's dashboard
    if (companyCode) {
      navigate(`/company-dashboard/${companyCode}`);
    } else {
