        ...
        .then((response) => {
          ...
          const filteredJobs =
            type === "Close the postion"
              ? fetchedJobs.filter((job) => job.status === "Open" || job.status === "Closed")
                    ...
                    if(type==="Post Job"){
                      ...
                      const handlePostJob = async () => {
                        const {title,Companyname}=job;
                         ...
                         try {
                           const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/post-job`, {title,Companyname});
