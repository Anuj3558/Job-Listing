...
const feedbacks = [
  {
    name: "John Doe",
    profilePicture: "https://i.pravatar.cc/50?img=1", // Random profile picture
    feedback:
  ...
  {
    name: "Jane Smith",
    profilePicture: "https://i.pravatar.cc/50?img=2", // Random profile picture
    feedback:
  ...
  {
    name: "Emily Johnson",
    profilePicture: "https://i.pravatar.cc/50?img=3", // Random profile picture
    feedback:
  ...
  {
    name: "Michael Brown",
    profilePicture: "https://i.pravatar.cc/50?img=4", // Random profile picture
    feedback:
  ...
  {
    name: "Sophia Davis",
    profilePicture: "https://i.pravatar.cc/50?img=5", // Random profile picture
    feedback:
  ...
  {
    name: "Daniel Wilson",
    profilePicture: "https://i.pravatar.cc/50?img=6", // Random profile picture
    feedback:
  ...
  {
    name: "Olivia Moore",
    profilePicture: "https://i.pravatar.cc/50?img=7", // Random profile picture
    feedback:
  ...
  {
    name: "James Taylor",
    profilePicture: "https://i.pravatar.cc/50?img=8", // Random profile picture
    feedback:
  ...
  {
    name: "Ava Anderson",
    profilePicture: "https://i.pravatar.cc/50?img=9", // Random profile picture
    feedback:
